<template>
  <div id="coupon-stats-div" style="height: 100%; width: 100%">
    <div class="row">
        ...
        series: [
          {
            ...
            type: "line",
            stack: "总量",
            data: [720, 632, 701, 734, 990, 1030, 1110],
          },
          {
            name: "领取量",
            type: "line",
        ...
        series: [
          {
            ...
            data: [
              { value: 1548, name: "合作推广" },
              { value: 775, name: "赞助推广", selected: true },
